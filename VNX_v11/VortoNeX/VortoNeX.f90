...
Subroutine OUTPUT_PLATE (step,den_aux) ! writes the output results file (for the plate's vortons) for Paraview; JCPG
    ...
    write(st,'(i12)') step
    st = adjustl(st)
        open(3,file='C:\Users\pimen\Documents\Visual Studio 2017\VNX_V11\VortoNeX\output_vtk\platevort_'//trim(st)//'.vtk')
...
Subroutine OUTPUT_WAKE (step) ! writes the output results file (for the vortons' wake) for Paraview; JCPG
    ...
    write(st,'(i12)') step
    st = adjustl(st)
        open(4,file='C:\Users\pimen\Documents\Visual Studio 2017\VNX_V11\VortoNeX\output_vtk\wakevort_'//trim(st)//'.vtk')
...
Subroutine OUTPUT_FIL (step) ! writes the output results file (for the wake grid) for Paraview; JCPG
    ...
    write(st,'(i12)') step
    st = adjustl(st)
        open(5,file='C:\Users\pimen\Documents\Visual Studio 2017\VNX_V11\VortoNeX\output_vtk\wakefil_'//trim(st)//'.vtk')
...
!    write(st,'(i12)') step
!    st = adjustl(st)
!        open(5,file='C:\Users\pimen\Documents\Visual Studio 2017\VNX_V11\VortoNeX\output_vtk\wakevort_'//trim(st)//'.vtk')
!        write(5,'(a)')'# vtk DataFile Version 2.0'
!        write(5,'(a)') 'This file was created by Fortran'
!        write(5,'(a)') 'ASCII'
!        write(5,'(a)') 'DATASET POLYDATA'
